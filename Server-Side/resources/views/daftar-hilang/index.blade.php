...
@section('content')
    <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Daftar Kehilangan Barang</h1><br>
    <div class="d-flex justify-content-center">
        @foreach ($kehilangan as $item)
            <div class="card mb-3" style="max-width: 540px">
                <div class="row g-0">
                    <div class="col-md-4">
                    <img src="{{ asset('/asset/img/'.$item->gambar) }}" class="img-fluid rounded-start" >
                    </div>
                    <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">Jenis Barang {{ $item->jenis }}</h5>
                        <p class="card-text">Tanggal Hilang {{ $item->tanggal }}</p>
