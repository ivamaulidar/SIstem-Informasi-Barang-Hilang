...
<html>
    <head>
        ...
        <title>Form Kehilangan Barang</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="css/hilang.css">
    ...
    <body>
        ...
        <div class="container">
            <div class="title">
                Lapor Kehilangan Barang Disini!
            </div>
            <form action="{{ route('daftar_barang_hilang.store') }}" method="POST" enctype="multipart/form-data">
                @csrf 
                <div class="user-detail">
                    ...
                    <div class="input-field"> 
                        <label for="tanggal">Tanggal Kehilangan</label><br>
