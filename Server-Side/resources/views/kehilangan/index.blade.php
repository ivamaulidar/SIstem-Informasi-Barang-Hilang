...
@section('title','Kehilangan Barang')
...
@section('content')
    <h1 class="h3 mb-4 text-gray-800">Kehilangan Barang</h1><br>
    <a href="{{ route('kehilangan.create') }}" type="button" class="btn btn-dark my-2"><i class="fa fa-plus"></i>Tambah Data</a>
